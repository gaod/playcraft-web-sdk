...
const havePointerQuery = '(any-pointer: fine) and (any-hover: hover)';
...
const SkipAdButton = ({
  ...
  return isLiveDuration(waitTime) && /*#__PURE__*/jsxRuntime.jsx(SkipButton, {
    waitTime: waitTime,
    onClick: skipAd
  });
};
