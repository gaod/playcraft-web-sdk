...
var UiAction = {
  ...
  toggleSettings: () => ({
    type: type$3.TOGGLE_SETTINGS
  }),
  hideSettings: () => ({
    type: type$3.HIDE_SETTINGS
  }),
  changeSettings: ({
    id,
    section,
...
const CastProvider = ({
  ...
  const [state, setState] = React.useState(initState$4);
...
const Provider = ({
  ...
  const getMessage = (code, property) => {
    return translations[code] && translations[code].replace(/{(\S+?)}/gi, (substring, name) => {
      ...
      const res = (_get2 = _get__default['default'](property, name)) !== null && _get2 !== void 0 ? _get2 : substring;
...
const loadBitmovin = async ({
  ...
  const bitmovinModules = [].concat(await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-engine-bitmovin')); }), nativeHls && (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-engine-native')); })), await Promise.all([Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-drm')); }), Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-abr')); }), Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-subtitles')); }), Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-container-mp4')); }), Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-style')); })]), nativeHls && (await Promise.all([Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-hls.js')); }), Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-subtitles-native.js')); })])), !nativeHls && (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-subtitles-vtt')); })), !nativeHls && (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-xml')); })), !nativeHls && (await Promise.all([Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-dash')); }), Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-mserenderer')); }), Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-polyfill')); })]))).filter(Boolean);
...
class BitmovinPlayer extends React.Component {
  ...
  mount() {
    ...
    Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('bitmovin-player/modules/bitmovinplayer-core')); }).then(({
      PlayerEvent
    }) => {
...
const PlayButton$2 = ({
  ...
  waitingStyle = 'spin',
  onClick
}) => waiting && waitingStyle === 'spin' ? 'waiting' : jsxRuntime$1.jsx(Button, {
...
const SimpleSlider = ({
  ...
  return jsxRuntime$1.jsxs("div", {
    ...
    }, position)), onChange ? jsxRuntime$1.jsx("div", {
      css: thumbStyle,
...
const Seekbar$1 = ({
  ...
  return jsxRuntime$1.jsxs("div", {
    ...
    }), formattedTime(duration), pointerActive && addons.map((Component, index) => jsxRuntime$1.jsx(Component, {
...
const VideoPlayer = ({
  ...
  React.useEffect(() => {
    loadPlayer(videoElement.current, {
      ...
      setPlayer(newPlayer);
      onPlayerLoaded === null || onPlayerLoaded === void 0 ? void 0 : onPlayerLoaded(newPlayer);

      if (playerRef) {
        playerRef.curret = newPlayer;
      }
    });
  ...
  const isWaiting = useLazyWaiting(waiting);
  const {
    mode,
    onClick,
    onMouseMove
  } = useAutoHide({
    pinned: !autohide || paused || isWaiting,
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Layout, {
    ...
    backRef: adContainer,
    seekbar: Number.isFinite(duration) && /*#__PURE__*/jsxRuntime.jsx(Seekbar$1, {
...
const getSelectedAudioName = player => {
  var _player$getAudio, _player$getAvailableA;

  const lang = player === null || player === void 0 ? void 0 : (_player$getAudio = player.getAudio()) === null || _player$getAudio === void 0 ? void 0 : _player$getAudio.lang;
  /*
  ...
  */
  ...
  return lang !== undefined ? lang : player === null || player === void 0 ? void 0 : (_player$getAvailableA = player.getAvailableAudio()[0]) === null || _player$getAvailableA === void 0 ? void 0 : _player$getAvailableA.lang;
};

const useSettings = () => {
  var _options$quality, _options$quality$getQ, _player$subtitles, _player$subtitles2, _player$subtitles2$li, _options$quality2, _selectedQuality$heig;
  ...
  const sections = getSettingSections({
    ...
    selectedSubtitleName,
    audioItems,
    selectedAudioName: getSelectedAudioName(player),
...
const useUiActions = () => {
  ...
  return {
    ...
    toggleSettings: () => dispatch(UiAction.toggleSettings()),
    hideSettings: () => dispatch(UiAction.hideSettings()),
...
const SettingButton = ({
  ...
  return sections.length > 0 && /*#__PURE__*/jsxRuntime.jsx(ControlsTooltip, {
    title: /*#__PURE__*/jsxRuntime.jsx(Message, {
      code: "KKS.SETTING"
    }),
    bottom: "48px",
    children: /*#__PURE__*/jsxRuntime.jsx(IconButton$1, {
      ...
      onClick: event => {
        ...
        if (!event.defaultPrevented && !open && !isDesktop()) {
          player.pause();
        }

        if (!open) {
          requestAnimationFrame(toggleSettings);
        }
      }
    })
  });
...
const TextButton = ({
  ...
  css: [style$8, center, "display:inline-block;" + (process.env.NODE_ENV === "production" ? "" : ";label:TextButton;"), process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
  onClick: onClick,
...
const Link = ({
  ...
  css: [style$6, center, process.env.NODE_ENV === "production" ? "" : ";label:Link;", process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
  onClick: onClick,
  children: jsxRuntime$1.jsx(I18n.Message, {
    code: text,
    defaultValue: defaultValue
...
const PlayPane = () => {
  const {
    status
  } = useStore(getPlaybackState, shallow__default['default']);
  const type = useStore(({
    UI: state
...
const RecommendationPanel = ({
  ...
  return children && jsxRuntime$1.jsx("div", {
    ...
    css: [style$4.container, !opening && style$4.folded, process.env.NODE_ENV === "production" ? "" : ";label:RecommendationPanel;", process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
    onClick: () => {
      if (!opening) {
        toggle();
      }
...
const BottomPanels = ({
  ...
  children: [recommendation && type === 'desktop' && jsxRuntime$1.jsxs(jsxRuntime$1.Fragment, {
    ...
    return jsxRuntime$1.jsxs("div", {
      ...
      }), content && /*#__PURE__*/React.cloneElement(content[0] || content, {
        active: panelOpen,
        close: hidePanel
      })]
    }, index);
...
var _ref$1 = process.env.NODE_ENV === "production" ? {
  ...
  map: "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */",
...
const VolumeControl = ({
  ...
  const iconName = muted ? icon.mute : volume < 0.5 ? icon.volumeLow : icon.volumeHight;
  return jsxRuntime$1.jsxs("div", {
...
const SeekPreview = ({
  ...
  return displayThumbnail ? jsxRuntime$1.jsx(VideoThumbnail$1, {
    css: thumbnailStyle,
    time: time,
...
const MenuSection = ({
  ...
  children: items.map(({
    ...
    css: [sharedStyle.row, selectedValue === value && sharedStyle.selected, process.env.NODE_ENV === "production" ? "" : ";label:MenuSection;", process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
    onClick: () => onSelect(value),
    children: [jsxRuntime$1.jsx(MenuItemText, {
      text: label || value
    }), jsxRuntime$1.jsx("div", {
      css: [style$2.space, process.env.NODE_ENV === "production" ? "" : ";label:MenuSection;", process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
    })]
  }, value))
});
...
const PlayerSettings = ({
  ...
  return jsxRuntime$1.jsx("div", {
    css: [sharedStyle.overlay, isSettingsOpen && style$2.opening, hasBottomPanel && {
      bottom: '8em'
    }, process.env.NODE_ENV === "production" ? "" : ";label:PlayerSettings;", process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
    onClick: event => event.stopPropagation(),
    children: jsxRuntime$1.jsxs("div", {
      ref: ref,
      ...
      children: [path === '/' && jsxRuntime$1.jsxs(React.Fragment, {
        children: [jsxRuntime$1.jsxs("div", {
          ...
          return jsxRuntime$1.jsxs("div", {
            css: [style$2.row, style$2.hasOptions, process.env.NODE_ENV === "production" ? "" : ";label:PlayerSettings;", process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
            onClick: () => setTimeout(() => setPath(`/${section}`), 1),
            children: [jsxRuntime$1.jsx(FormattedMessage, {
              id: title
            }), jsxRuntime$1.jsx("div", {
              css: [style$2.space, process.env.NODE_ENV === "production" ? "" : ";label:PlayerSettings;", process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"]
...
}, // TODO a shotgun parameter here, to be refactored
{
  ...
  const controlButtons = {
    playButton: status === 'loading' ? '' : type === 'mobile' && status === 'buffering' ? jsxRuntime$1.jsx(Loading, {
      styles: {
        position: 'static',
        width: '3em',
        margin: '1em',
  ...
  const backItems = status !== 'buffering' && controlsDisplay !== 'hidden' && jsxRuntime$1.jsx(PlayPane, {});
  ...
  const uiElements = adStatus ? {
    ...
    title,
    channelTitle,
    functionButtons: ready && (type === 'mobile' || width >= sizes['small-embed']) && jsxRuntime$1.jsx(FunctionButtons, {
  ...
  const {
    ...
    setUnmuteVolume: volume => unmuteVolume.current = volume
  }));
  return {
    ...
    ...uiElements,
    controlButtons,
    volumeControl: width >= sizes['small-embed'] && jsxRuntime$1.jsx(VolumeControl // iOS video volume locks to 1, sliders is no use (OTP-1878)
    , {
      slider: width >= 300 && !isIOS(),
      subscribe,
      onChange,
      toggleMute
    }),
    fullscreenButton: ready && jsxRuntime$1.jsx(FullScreenButton, {}),
    backButton: goBack && jsxRuntime$1.jsx(BackButton, {
      onClick: goBack
    }),
    backItems
  };
...
const PlayerUi = ({
  ...
  const livesMeta = useStore(({
    API
  }) => getLivesMeta(API.content), shallow__default['default']);
  ...
  const {
    dispatch
  } = React.useContext(Context.Adapter);
  ...
  const selectedQuality = useStore(state => getSelectedQuality(state, options.quality), shallow__default['default']);
  ...
  return jsxRuntime$1.jsxs(jsxRuntime$1.Fragment, {
    children: [jsxRuntime$1.jsxs(VideoPlayer, {
    ...
    }), jsxRuntime$1.jsx(AutoplayDialog, {}), status === 'error' ? jsxRuntime$1.jsx(ErrorOverlay, {
      goBack: options.goBack
    }) : status === 'casting' ? jsxRuntime$1.jsx(CastingOverlay, {}) : status === 'linearEnded' ? jsxRuntime$1.jsx(LinearEndedOverlay, {}) : '', jsxRuntime$1.jsx(CoverImageWrap, {
      url: coverImageUrl
    })]
  });
};
  ...
  return jsxRuntime$1.jsx("div", {
    ...
    children: jsxRuntime$1.jsx(PlayerProvider, {
      ...
      children: jsxRuntime$1.jsxs(StoreProvider, {
        store: store,
        options: options,
        children: [jsxRuntime$1.jsx(PlayerVideo // for bitmovin bindings, previously <PlayerVideo>, no longer renders video now
        , {
          plugins: plugins,
