      ...
      try {
        ...
        switch (action.type) {
          ...
          case type$2.SEEK:
            ...
            if (Math.abs(this.player.getVideoElement().currentTime - action.time) > 0.5) {
...
const VideoPlayer = ({
  ...
  }, [player, source === null || source === void 0 ? void 0 : source.hls, source === null || source === void 0 ? void 0 : source.dash]);
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Layout, {
    ...
    backItems: waiting ? /*#__PURE__*/jsxRuntime.jsx(LoadingSpinner, {}) : layoutProps.backItems,
    onClick: onClick,
...
const getUiElements = ({
  ...
  return {
    ...
    ...uiElements,
    controlButtons,
    volumeControl: width >= sizes['small-embed'] && jsxRuntime$1.jsx(VolumeControl, {
...
const loadOverrides = async ({
  ...
  const {
    data
  } = await axios__default['default'].get(hls);
...
const PlayerUi = ({
  ...
  const drm = ready && ((_options$drm = options.drm) === null || _options$drm === void 0 ? void 0 : _options$drm.call(options, {
    host,
    token,
    headers,
    widevine: {
  ...
  const {
    qualitySelectionHack
  } = needNativeHls() && (options.quality || {}); // Quality selection is disabled in Safari.
  // Users open qualitySelectionHack flag to make us do workaround.

  const [sourceOverrides, setSourceOverrides] = React.useState(qualitySelectionHack && 'loading');
  React.useEffect(() => {
    if (qualitySelectionHack) {
      ...
      if (source !== null && source !== void 0 && source.hls) {
        loadOverrides({ ...source,
          filterQualities: qualities => options.onVideoQualityChanged({
            qualities,
  ...
  }, [qualitySelectionHack && (source === null || source === void 0 ? void 0 : source.hls), selectedQuality]);
  ...
  return jsxRuntime$1.jsxs(CoverImageWrap, {
    ...
    children: [jsxRuntime$1.jsxs(VideoPlayer, {
      source: ready && sourceOverrides !== 'loading' && { ...source,
        ...sourceOverrides
      },
      ...
      }), status === 'error' ? jsxRuntime$1.jsx(ErrorOverlay, {}) : status === 'casting' ? jsxRuntime$1.jsx(CastingOverlay, {}) : status === 'linearEnded' ? jsxRuntime$1.jsx(LinearEndedOverlay, {}) : '', jsxRuntime$1.jsx(PlayerSettings, {
        desktop: isDesktop(),
