...
const useLinkState = (request, dependencies = []) => {
  ...
  useEffect(() => request(setState), dependencies);
  return state;
};
...
const PremiumPlusPlayer = ({
  ...
  const endSession = ({
    ...
    if ((_lastSession$current = lastSession.current) !== null && _lastSession$current !== void 0 && _lastSession$current.updateLastPlayed) {
      lastSession.current.updateLastPlayed();
    }

    if ((_lastSession$current2 = lastSession.current) !== null && _lastSession$current2 !== void 0 && _lastSession$current2.end) {
  ...
  return /*#__PURE__*/jsxs$1(PremiumPlayer, {
    ...
    onPlaybackStateChange: (event, state) => {
      ...
      if (state === 'error') {
        ...
        (_lastSession$current$ = (_lastSession$current3 = lastSession.current).end) === null || _lastSession$current$ === void 0 ? void 0 : _lastSession$current$.call(_lastSession$current3);
      ...
      if (state === 'paused' && playbackState !== 'loading' || event.type === 'seeking') {
        ...
        (_lastSession$current$2 = (_lastSession$current4 = lastSession.current).updateLastPlayed) === null || _lastSession$current$2 === void 0 ? void 0 : _lastSession$current$2.call(_lastSession$current4);
      }
...
export { CastSender, FunctionBarExtension, PremiumPlayer, PremiumPlusPlayer, Video, VideoPlayer };
