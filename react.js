...
const syncPlaybackState = (media, {
  ...
  if (target === 'playing') {
    ...
    if (media.paused) {
      const seekable = plugins.reduce((prev, plugin) => {
        var _plugin$getSeekbarPro;

        return ((_plugin$getSeekbarPro = plugin.getSeekbarProps) === null || _plugin$getSeekbarPro === void 0 ? void 0 : _plugin$getSeekbarPro.call(plugin).seek) === null ? false : prev;
      }, true);
      /**
       ...
       *
       * TODO: This may conflict with low latency player logic.
       */

      if (player.isLive() && needNativeHls() && !seekable) {
        seek(media, {
          player
        }, Number.MAX_VALUE);
      }
...
const getQualitySettings = (options, player) => {
  ...
  const items = streamingProtocol === 'hls' && !options.rewriteManifest ? [] : options[streamingProtocol] || getQualityItemsFromManifest(player);
...
const getSettingsData = ({
  ...
  const sections = [quality && getQualitySettings(quality, player), shouldShowSubtitles(subtitleItems) && {
    name: 'subtitles',
    title: 'KKS.SUBTITLES',
    items: [...subtitleItems, {
      label: 'OFF',
...
const CastProvider = ({
  ...
  const [state, setState] = useState({ ...initState$1,
    appId,
...
const PlayDialog = ({
  ...
  return jsxs("div", {
    css: [style$2.container, sizes$1[size], opening && style$2.opening, process.env.NODE_ENV === "production" ? "" : ";label:PlayDialog;", process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
    ref: containerRef,
    ...rest,
    children: [jsx$1("button", {
      type: "button",
...
const RecommendationPanel = ({
  ...
  children: jsxs("div", {
    css: [style$1.container, open && style$1.open, process.env.NODE_ENV === "production" ? "" : ";label:RecommendationPanel;", process.env.NODE_ENV === "production" ? "" : "/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"],
    onClick: () => {
      if (!open) {
        onToggle();
      }
...
var reduceUi = ((state = initState, action) => {
  switch (action.type) {
...
const LinearTimeRewrite = () => {
  ...
  const programTimeForPresentationTime = astTime => {
    var _ref$player;

    return (// eslint-disable-next-line no-unsafe-optional-chaining
      astTime + ((_ref$player = ref.player) === null || _ref$player === void 0 ? void 0 : _ref$player.getPresentationStartTimeAsDate()) / 1000 - config.start
    );
  };

  const presentationTimeForProgramTime = programTime => {
    var _ref$player2;

    return programTime + config.start - // eslint-disable-next-line no-unsafe-optional-chaining
    ((_ref$player2 = ref.player) === null || _ref$player2 === void 0 ? void 0 : _ref$player2.getPresentationStartTimeAsDate()) / 1000;
  };
  ...
  return {
    ...
    getPlaybackStatus: () => {
      ...
      if (config.seekable === 'auto' || config.seekable.end === SEEKABLE_END.PROGRAM_END) {
      ...
      return {
        duration: Math.floor((Date.now() - state.baseTimeInMs) / 1000) + state.seekRangeEnd,
    ...
    getSeekbarProps: () => {
      ...
      if (!((_ref$player4 = ref.player) !== null && _ref$player4 !== void 0 && _ref$player4.isLive()) || !config.seekable) return {};
      const seekRangeEnd = programTimeForPresentationTime(ref.player.seekRange().end);
    ...
    handleSeek: (time, seekInternal) => {
      seekInternal(Math.min(presentationTimeForProgramTime(time), ref.player.seekRange().end));
    },
    isActive: () => ref.player.isLive() && config.seekable
  };
};
...
const PremiumPlusPlayer = ({
  ...
  const [uiState, dispatch] = useReducer(reduceUi, initState); // Provide the content from the cache as soon as possible when the content has changed
  ...
  }, [(_contentData$section5 = contentData.section) === null || _contentData$section5 === void 0 ? void 0 : _contentData$section5.end, (_contentData$section6 = contentData.section) === null || _contentData$section6 === void 0 ? void 0 : _contentData$section6.start, linearTimeRewritePlugin, seekConfig]);
